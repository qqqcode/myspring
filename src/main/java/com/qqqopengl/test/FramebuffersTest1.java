...
public class FramebuffersTest1 {
    ...
    public static void fun() {
        ...
        float[] floorVertices = {
                ...
                5.0f, -0.5f, 0f, 1.0f, 0.0f,
                -5.0f, -0.5f, 0f, 0.0f, 0.0f,
                -5.0f, -0.5f, 0f, 0.0f, 1.0f,

                5.0f, -0.5f, 0f, 1.0f, 0.0f,
                -5.0f, -0.5f, 0f, 0.0f, 1.0f,
                5.0f, -0.5f, 0f, 1.0f, 1.0f
        };
        float[] quadVertices = {
                // Positions   // TexCoords
                -1.0f, 1.0f, 0.0f, 1.0f,
...
//        quadVAO.unbind();
        ...
        Texture floorTexture = Texture.loadTexture(Constant.resources + "container.jpg",true);
